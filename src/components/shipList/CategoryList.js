...
import ItemInShipList from '../shipListItem/ItemInShipList';
import {shipListItems, categories, products, productTypes, SELECAO_DIRETA, SELECAO_POR_TIPO_TAMANHO} from '../dataApp';
